...
function toggleTheme(switchToTheme) {
    ...
    // add 'toggled-on' to the desired label based on switchToTheme value
    ...
    } else if (switchToTheme === 'theme3') {
        themeToggles[2].classList.add('toggled-on');
    } else if(switchToTheme === 'theme4') {
        themeToggles[3].classList.add('toggled-on');
    }
